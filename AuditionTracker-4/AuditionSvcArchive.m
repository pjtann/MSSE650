...
/////*
//
// // remark out for testing hard code archive file
//    NSArray *dirPaths =
...
//{
//
//    // add the audition to the local array, then go to the writeAuditionArchive method to refresh the archive file
//  
